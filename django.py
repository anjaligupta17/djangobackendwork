...
def data(request):
    ...
    add = [[Limited_Balance, Education , Marriege , Age , Pay1 , last_bill1 , last_bill2 , last_bill3 , last_bill4 , last_bill5 , last_bill6 , amount_paid1 , amount_paid2 , amount_paid3 , amount_paid4 , amount_paid5 , amount_paid6]]
...
def result(request):
    ...
    return render(request, 'index.html', {'pred' : x})